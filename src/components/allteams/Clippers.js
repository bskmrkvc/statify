import logo from '../../assets/img/clippers.png';
import './ClippersTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-clippers">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    ...
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}> Los Angeles Clippers, San Diego Clippers, Buffalo Braves</h4>
            ...
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Los Angeles Clippers Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-clippers-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The Los Angeles Clippers are an American professional basketball team based in Los Angeles.
          The Clippers compete in the National Basketball Association (NBA) as a member of the Pacific Division in the league's Western Conference. The Clippers play their home games at Crypto.com Arena, which they share with NBA team Los Angeles Lakers, the Los Angeles Sparks of the Women's National Basketball Association (WNBA), and the Los Angeles Kings of the National Hockey League (NHL).
          The Clippers plan to move into their own arena, the Intuit Dome, in nearby Inglewood by 2024.</h3>
        </div>
