import logo from '../../assets/img/heat.png';
import './HeatTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-heat">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> Miami, Florida </h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}>  Miami Heat </h4>
                    <h4>Seasons:</h4><h4 style={{fontWeight: 'normal'}}>   35; 1988-89 to 2022-23 </h4>
                    <h4>Championships:</h4><h4 style={{fontWeight: 'normal'}}> 3 </h4>
                  </div>
              </div>
            </span>
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Miami Heat Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-heat-roster">
