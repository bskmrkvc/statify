import logo from '../../assets/img/kings.png';
import './KingsTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-kings">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> Sacramento, California </h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}>  Sacramento Kings, Kansas City Kings, Kansas City-Omaha Kings, Cincinnati Royals, Rochester Royals </h4>
            ...
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Sacramento Kings Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-kings-roster">
...
The franchise again failed to find success in its market and moved after the 1984–85 season to Sacramento, where they presently reside. Since 2006, the Kings have had sixteen consecutive losing seasons, the most in NBA history.</h3>
        </div>
