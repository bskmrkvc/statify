import logo from '../../assets/img/magic.png';
import './MagicTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-magic">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> Orlando, Florida </h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}> Orlando Magic </h4>
                    <h4>Seasons:</h4><h4 style={{fontWeight: 'normal'}}> 34; 1989-90 to 2022-23 </h4>
                    <h4>Championships:</h4><h4 style={{fontWeight: 'normal'}}> 0 </h4>
                  </div>
              </div>
            </span>
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Orlando Magic Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-magic-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The Orlando Magic are an American professional basketball team based in Orlando, Florida. The Magic compete in the National Basketball Association (NBA) as a member of the league's Eastern Conference Southeast Division.
          The franchise was established in 1989 as an expansion franchise, and such notable NBA stars as Shaquille O'Neal, Penny Hardaway, Grant Hill, Tracy McGrady, Dwight Howard, Jameer Nelson, Rashard Lewis and Nikola Vučević have played for the club throughout its history. As of 2021, the franchise has played in the NBA playoffs 16 times in 32 seasons, and twice went to the NBA Finals, in 1995 and 2009.
          Orlando has been the second most successful of the four expansion teams brought into the league in 1988 and 1989 in terms of winning percentage and playoff success, after the Miami Heat.</h3>
        </div>
