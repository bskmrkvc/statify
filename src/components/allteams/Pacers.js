import logo from '../../assets/img/pacers.png';
import './PacersTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-pacers">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> Indianapolis, Indiana</h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}>  Indiana Pacers</h4>
                    <h4>Seasons:</h4><h4 style={{fontWeight: 'normal'}}>  56 (47 NBA & 9 ABA); 1967-68 to 2022-23</h4>
                    <h4>Championships:</h4><h4 style={{fontWeight: 'normal'}}>3 (0 NBA & 3 ABA)</h4>
                  </div>
              </div>
            </span>
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Indiana Pacers Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-pacers-roster">
