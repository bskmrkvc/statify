import logo from '../../assets/img/pelicans.png';
import './PelicansTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-pelicans">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> New Orleans, Louisiana </h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}>  New Orleans Pelicans, New Orleans/Oklahoma City Hornets, New Orleans Hornets </h4>
                    <h4>Seasons:</h4><h4 style={{fontWeight: 'normal'}}> 21; 2002-03 to 2022-23 </h4>
                    <h4>Championships:</h4><h4 style={{fontWeight: 'normal'}}> 0 </h4>
                  </div>
              </div>
            </span>
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="New Orleans Pelicans Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-pelicans-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The New Orleans Pelicans (often referred to as the Pels) are an American professional basketball team based in New Orleans. The Pelicans compete in the National Basketball Association (NBA) as a member of the league's Western Conference Southwest Division and play their home games at the Smoothie King Center. The NBA considers New Orleans an expansion team that began play in the 2002–03 season.

The Pelicans were established as the New Orleans Hornets in the 2002–03 season when George Shinn, then owner of the Charlotte Hornets, relocated the franchise to New Orleans. Due to the damage caused by Hurricane Katrina in 2005, the team temporarily relocated to Oklahoma City, where they spent two seasons as the New Orleans/Oklahoma City Hornets before returning to New Orleans for the 2007–08 season. In 2013, the Hornets announced that they would change their name to the New Orleans Pelicans after the 2012–13 season.</h3>
        </div>
