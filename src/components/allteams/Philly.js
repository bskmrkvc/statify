import logo from '../../assets/img/76ers.png';
import './PhillyTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-philly">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> Philadelphia, Pennsylvania </h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}> Philadelphia 76ers, Syracuse Nationals </h4>
                    <h4>Seasons:</h4><h4 style={{fontWeight: 'normal'}}> 74; 1949-50 to 2022-23 </h4>
                    <h4>Championships:</h4><h4 style={{fontWeight: 'normal'}}> 3 </h4>
                  </div>
              </div>
            </span>
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Philladelphia 76ers Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-philly-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The Philadelphia 76ers, colloquially known as the Sixers, are an American professional basketball team based in the Philadelphia metropolitan area.
          The 76ers compete in the National Basketball Association (NBA) as a member of the league's Eastern Conference Atlantic Division and play at the Wells Fargo Center located in the South Philadelphia Sports Complex.
          Founded in 1946 and originally known as the Syracuse Nationals, they are one of the oldest franchises in the NBA and one of only eight (out of 23) to survive the league's first decade.</h3>
        </div>
