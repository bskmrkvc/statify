import logo from '../../assets/img/pistons.png';
import './PistonsTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-pistons">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}>Detroit, Michigan</h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}>Detroit Pistons, Fort Wayne Pistons</h4>
            ...
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Denver Pistons Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-pistons-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The Detroit Pistons are an American professional basketball team based in Detroit.
          ...
          The Pistons later joined the Basketball Association of America (BAA) in 1948. The NBL and BAA merged to become the NBA in 1949, and the Pistons became part of the merged league. In 1957, the franchise moved to Detroit. The Pistons have won three NBA championships: in 1989, 1990 and 2004.</h3>
        </div>
