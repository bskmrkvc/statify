import logo from '../../assets/img/warriors.png';
import './WarriorsTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-warriors">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> San Francisco, California</h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}> Golden State Warriors, San Francisco Warriors, Philadelphia Warriors</h4>
                    <h4>Seasons:</h4><h4 style={{fontWeight: 'normal'}}>77; 1946-47 to 2022-23</h4>
                    <h4>Championships:</h4><h4 style={{fontWeight: 'normal'}}>7</h4>
                  </div>
              </div>
            </span>
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Golden State Warriors Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-warriors-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The Golden State Warriors are an American professional basketball team based in San Francisco. 
          The Warriors compete in the National Basketball Association (NBA), as a member of the league's Western Conference Pacific Division. Founded in 1946 in Philadelphia, the Warriors moved to the San Francisco Bay Area in 1962 and took the city's name, before changing its geographic moniker to Golden State in 1971.
           The club plays its home games at the Chase Center.</h3>
        </div>
