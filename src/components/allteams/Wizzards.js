import logo from '../../assets/img/wizzards.png';
import './WizzardsTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-wizzards">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> Washington, District of Columbia </h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}> Washington Wizards, Washington Bullets,<br/>Capital Bullets, Baltimore Bullets,
                    Chicago Zephyrs, Chicago Packers </h4>
                    <h4>Seasons:</h4><h4 style={{fontWeight: 'normal'}}> 62; 1961-62 to 2022-23 </h4>
                    <h4>Championships:</h4><h4 style={{fontWeight: 'normal'}}> 1 </h4>
                  </div>
              </div>
            </span>
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Washington Wizzards Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-wizzards-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The Washington Wizards are an American professional basketball team based in Washington, D.C. The Wizards compete in the National Basketball Association (NBA) as a member of the league's Eastern Conference Southeast Division. The team plays its home games at the Capital One Arena, in the Chinatown neighborhood of Washington, D.C.
