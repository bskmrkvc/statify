import logo from '../../assets/img/wolves.png';
import './WolvesTeamStyle.css';
    ...
    return (
      <div className="App">
        ...
        <div className="banner-teams-wrapper">
          <div className="banner-teams-wolves">
            <span>
              <div className="left-side">
                <h1 className="team-name"> 
                  ...
                  <div className="team-info">
                    <h4>Location:</h4><h4 style={{fontWeight: 'normal'}}> Minneapolis, Minnesota </h4>
                    <h4>Team Names:</h4><h4 style={{fontWeight: 'normal'}}> Minnesota Timberwolves </h4>
            ...
            <span className="team-logo-span">
              <img src={logo} className="team-logo-teams" alt="Minnesota Timberwolves Logo"></img>
            </span>
          </div>
        </div>
        ...
        {/* roster */}
        <div className="teams-wolves-roster">
        ...
        <div>
          ...
          <h3 className="about-text">The Minnesota Timberwolves are an American professional basketball team based in Minneapolis. The Timberwolves compete in the National Basketball Association (NBA) as a member of the league's Western Conference Northwest Division.
          Founded in 1989, the team is owned by Glen Taylor who also owns the WNBA's Minnesota Lynx. The Timberwolves play their home games at Target Center, their home since 1990</h3>
        </div>
